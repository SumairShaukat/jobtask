...
import { ProductsFields } from "../data/index";
  ...
  return (
    <>
      <FormProvider {...methods}>
        <form onSubmit={methods.handleSubmit(onAddProducts)} className="w-full">
          <FormGenerator title="Basic Info" inputs={ProductsFields} />
